...
class main:
    def __init__(self):
        ...
        elif action == 'pages_games':               pages().games('livetv_nhl')
        elif action == 'pages_highlights':          pages().highlights('livetv_nhl')
        elif action == 'pages_teams':               pages().teams('livetv_nhl_teams')
        elif action == 'videos':                    videos().get(url)
        elif action == 'videos_all':                videos().get2(url)
        elif action == 'videos_added':              videos().root('livetv_nhl')
