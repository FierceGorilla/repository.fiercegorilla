...
app_signature = str(0xceed20e0)  # 0xa2317cf8 0xeaa75001 0x22d78bd5 0x1e2f98cc
...
def get_lb_media_url(relayer):
    ...
    headers = [
        ...
        a2b_hex("582d5265717565737465642d576974683d322e312e37253230467265656d69756d").decode("utf-8"),
    ]
