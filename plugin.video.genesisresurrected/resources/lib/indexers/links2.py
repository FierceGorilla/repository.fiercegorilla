...
class tvshows:
    def __init__(self):
        ...
        self.TopRated_link = 'http://api.themoviedb.org/3/tv/top-rated?api_key=%s&page=1' % self.tmdb_key
        self.tmdbcoming_link = 'http://api.themoviedb.org/3/movie/upcoming?api_key=%s&page=1' % self.tmdb_key
        ...
        self.tmdbanimationtv_link = 'http://api.themoviedb.org/3/list/34348?api_key=%s' % (self.tmdb_key)
    ...
    def tvshowDirectory(self, items):
        ...
        for i in items:
            try:
                ...
                if not tvdb == "0" or tvdb == None: sysmetalliq = "plugin://plugin.video.metalliq/tv/add_to_library_parsed/%s/direct.genesisreborn.q" % tvdb
                else: sysmetalliq = "0"
