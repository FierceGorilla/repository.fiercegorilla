...
"""
    //genesisresurrected Add-on//
    Updated for genesisresurrected Add-on
...
def metaFile():
    if condVisibility('System.HasAddon(script.genesisresurrected.metadata)'):
        return os.path.join(xbmcaddon.Addon('script.genesisresurrected.metadata').getAddonInfo('path'), 'resources', 'data', 'meta.db')
